...
class Set14(tfds.core.GeneratorBasedBuilder):
    ...
    def __init__(
        ...
        super(Set14, self).__init__(data_dir=data_dir, config=config, version=version)
    ...
    def _info(self):
        return tfds.core.DatasetInfo(
            ...
            features=tfds.features.FeaturesDict(
                {"lr": tfds.features.Image(), "hr": tfds.features.Image()}
            ),
    ...
    def _generate_examples(self, images_dir_path):
        ...
        for image_file in tf.io.gfile.listdir(images_dir_path):
            if image_file.endswith("png"):
                ...
                yield image_id, {"hr": image_path, "lr": image_path}
    ...
    def _as_dataset(
        ...
        dataset = super(Set14, self)._as_dataset(
            split=split,
            decoders=decoders,
        ...
        def downsample(x):
            ...
            lr_size = (hr_shape[0] // self.scale, hr_shape[1] // self.scale)
